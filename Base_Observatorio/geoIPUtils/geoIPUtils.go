// Este archivo proporciona utilidades para interactuar con bases de datos GeoIP,
// incluyendo inicialización, cierre, descarga y consulta de datos GeoIP.
...
// GeoipDB estructura que contiene referencias a bases de datos GeoIP de países y ASN.
type GeoipDB struct {
	CountryDb *geoip2.Reader
	AsnDb     *geoip2.Reader
}

// InitGeoIP inicializa las bases de datos GeoIP.
// Descarga las bases de datos si no están presentes o no están actualizadas.
...
// CloseGeoIP cierra las bases de datos GeoIP.
...
// downloadGeoIp descarga y descomprime las bases de datos GeoIP en formato tar.gz.
...
// downloadFile descarga un archivo de una URL y lo extrae si está comprimido.
